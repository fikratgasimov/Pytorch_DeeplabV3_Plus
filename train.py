...
from dataloaders.datasets import apolloscape
...
def main():
    ...
    if args.checkname is None:
        ...
        # modification on arg.checkname
        args.checkname = 'deeplab_' + str(args.backbone)

    print(args.checkname)
    torch.manual_seed(args.seed)

    # Training set is set to args
    # addition of deeplab_xception
